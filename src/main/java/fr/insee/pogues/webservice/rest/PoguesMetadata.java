...
public class PoguesMetadata {
    ...
    @ApiOperation(
            value = "Gets the item with id {id}",
            notes = "Get an item from Colectica Repository, given it's {id}",
    ...
    @Path("item/{id}/refs/")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = "Get the children refs with parent id {id}",
    ...
    @ApiOperation(
            value = "Get all de-referenced items",
